...
class AllStatement extends StatefulWidget {
  const AllStatement({Key? key}) : super(key: key);

  @override
  _AllStatementState createState() => _AllStatementState();
}
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: PaginatedDataTable(
          header: const Text("Statement").centered(),
...
class DessertDataSource extends DataTableSource {
  ...
  final List<Dessert> _desserts = <Dessert>[
    Dessert(1, "Anas Mughal", 03023759375, "Khanpur", "A+", "Donate",
        now.toString()),
    Dessert(2, "Anas Mughal", 03023759375, "Khanpur", "A+", "Receive",
        now.toString())
  ];
  @override
