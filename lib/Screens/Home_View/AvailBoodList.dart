...
class AvailBloodList extends StatefulWidget {
  const AvailBloodList({Key? key}) : super(key: key);

  @override
  _AvailBloodListState createState() => _AvailBloodListState();
}

class _AvailBloodListState extends State<AvailBloodList> {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: PaginatedDataTable(
          header: const Text("Available Blood List").centered(),
